...
public class Read extends AppCompatActivity {
    ...
    public void loadData() {
        ...
        Query fireBaseQusery  = ref.orderByChild("admin_wire_check").equalTo("null") ;
            ...
            protected void onBindViewHolder(@NonNull final ViewHolderPost viewHolderPost, final  int i, @NonNull final Post_Model post_model) {
                ...
                viewHolderPost.done.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        adapter=new MyAdapter(getApplicationContext(),arrayList,getRef(i).getKey(),"to_wire",post_model.getCondition_amount(),post_model.getBdt());

                        LayoutInflater layoutInflater = LayoutInflater.from(Read.this);

                        final View view = layoutInflater.inflate(R.layout.recycle, null);

                        recyclerView1 = view.findViewById(R.id.myList);
                        recyclerView1.setLayoutManager(new LinearLayoutManager(Read.this));
